# Since this is made by using a Free API it has a limit for the number of requests. If it shows Error:429 that means you just need to wait for one day or make a new account in Rapid API and replace the key.
